...
### feature + hour + day
from functions import comb_click_time
df_train = comb_click_time(df_train, feature=['ip'], gourps=['hour', 'day']) #need to add ip because it did not include in fcols.

###Top 10 clicking in each feature
from functions import top_10c
